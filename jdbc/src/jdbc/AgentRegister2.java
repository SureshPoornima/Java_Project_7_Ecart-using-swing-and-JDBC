...
public class AgentRegister2 {
	public void agentRegister() throws SQLException {
			    ...
			    b.addActionListener(new ActionListener(){  
			    	public void actionPerformed(ActionEvent e){  
			            ...
			            try {
							...
							statement.executeUpdate("INSERT INTO agentdata VALUES ('"+agentid+"','"+first+"','"+last+"','"+email+"','"+phone+"','"+user+"','"+pass+"','"+repass+"')");
